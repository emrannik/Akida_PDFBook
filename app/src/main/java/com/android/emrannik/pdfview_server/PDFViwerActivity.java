...
import com.android.emrannik.pdfview_server.fragment_pack.FeedFragment;
...
public class PDFViwerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FileLoader.with(this)
                .load(FeedFragment.list.get(position).getPdfUrl())
                ...
                .asFile(new FileRequestListener<File>() {
                    ...
                    public void onLoad(FileLoadRequest request, FileResponse<File> response) {
                        ...
                        pdfView.fromUri(Uri.parse(FeedFragment.list.get(position).getPdfUrl()))
                                .password(null)
                                .defaultPage(0)
                                .enableSwipe(true)
